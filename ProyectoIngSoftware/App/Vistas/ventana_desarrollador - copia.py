...
class Dev(ctk.CTk):
    ...
    # Agregar los radio buttons debajo de los campos de texto
        role_picker = ctk.CTkLabel(frame_entries_and_radios, text="Elige tu rol:", font=("Comic Sans", -25, "bold"))
        role_picker.grid(row=len(labels), column=0, padx=10, pady=10, sticky="w")

        self.radio_var = ctk.StringVar(value="")
        radiobutton_1 = ctk.CTkRadioButton(frame_entries_and_radios, text="Entrada Externa", font=("Comic Sans", -18), variable=self.radio_var, value="Entrada Externa")
        radiobutton_1.grid(row=len(labels) + 1, column=0, padx=10, pady=5, sticky="w")
        radiobutton_2 = ctk.CTkRadioButton(frame_entries_and_radios, text="Salida Externa", font=("Comic Sans", -18), variable=self.radio_var, value="Salida Externa")
        radiobutton_2.grid(row=len(labels) + 2, column=0, padx=10, pady=5, sticky="w")
        radiobutton_3 = ctk.CTkRadioButton(frame_entries_and_radios, text="Archivo logico Interno", font=("Comic Sans", -18), variable=self.radio_var, value="Archivo logico Interno")
